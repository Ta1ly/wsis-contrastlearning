...
if __name__ == "__main__":
    ...
    folders = [## fs
                ...
                # 'residual_all_unary_pair', 
                # #
                # ## ablation study - fix bbox disturbution
                # 'residual_all_unary_pair_fix_margin_1',
                # 'residual_all_unary_pair_fix_margin_2',
                # 'residual_all_unary_pair_fix_margin_4',
                # 'residual_all_unary_pair_fix_margin_8',
                # ## ablation study - random bbox disturbution
                # 'residual_all_unary_pair_random_margin_1',
                # 'residual_all_unary_pair_random_margin_2',
                # 'residual_all_unary_pair_random_margin_4',
                # 'residual_all_unary_pair_random_margin_8',
                # # ablation study - generalized mil
                # 'residual_parallel_focal_40_10_unary_pair',
                # 'residual_parallel_focal_40_20_unary_pair',
                # 'residual_parallel_focal_60_30_unary_pair',
                # ## ablation study - fix bbox disturbution for generaliezed mil
                # 'residual_parallel_focal_unary_pair_fix_margin_1',
                # 'residual_parallel_focal_unary_pair_fix_margin_2',
                # 'residual_parallel_focal_unary_pair_fix_margin_4',
                # 'residual_parallel_focal_unary_pair_fix_margin_8',
                # # ## ablation study - random bbox disturbution for generaliezed mil
                # # 'residual_parallel_focal_unary_pair_fix_margin_1',
                # # 'residual_parallel_focal_unary_pair_fix_margin_2',
                # # 'residual_parallel_focal_unary_pair_fix_margin_4',
                # # 'residual_parallel_focal_unary_pair_fix_margin_8',
                # ## ablation study - strong baseline(tightness prior)
                # 'residual_parallel_approx_focal_40_20_expsumr=4_unary_pair',
                # 'residual_parallel_approx_focal_40_20_expsumr=6_unary_pair',
                # 'residual_parallel_approx_focal_40_20_expsumr=8_unary_pair',
                # ## ablation study - fix bbox disturbution for generaliezed mil
                # 'residual_parallel_explogs_fix_margin_1',
                # 'residual_parallel_explogs_fix_margin_2',
                # 'residual_parallel_explogs_fix_margin_4',
                # # 'residual_parallel_explogs_fix_margin_8',
                # 'residual_parallel_explogs_fix_margin_4',
                'test_resunet_cam',
                'test_resunet_cam_margin_2',
                'test_resunet_cam_margin_4',
                'test_resunet_cam_margin_8',
                'mil_resunet_cam_margin_1',
                'mil_resunet_cam_margin_2',
                'mil_resunet_cam_margin_4',
                'mil_resunet_cam_margin_8',
               ]
